...
/**
 * Validates whether the annotated field value is in the future or present.
 *
...
annotation class FutureOrPresent {
    ...
    /**
     * [ConstraintValidator] for the [FutureOrPresent] constraint.
     */
    class Validator : ConstraintValidator<FutureOrPresent> {
